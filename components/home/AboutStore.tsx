    ...
    return (
        <div className="flex items-stretch lg:flex-row flex-col">
            <div className="lg:w-1/2 w-full p-10 relative bg-blue-700 flex flex-col">
                ...
                <div className="relative lg:left-40 left-0 z-10 py-10 pl-10 lg:pr-16 pr-10 max-w-lg border-white border-solid border-4">
            ...
            <div className="lg:w-1/2 w-full bg-black text-white lg:p-20 p-10 flex flex-col">
                <div className="space-y-6">
                    ...
                    <StatItem icon="f" count="2,000 +" label="FACEBOOK FANS -" desc="Vivamous molestie gravida turpis" />
